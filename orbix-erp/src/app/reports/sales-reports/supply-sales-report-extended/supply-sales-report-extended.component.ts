...
@Component({
  selector: 'app-supply-sales-report-extended',
  templateUrl: './supply-sales-report-extended.component.html',
  styleUrls: ['./supply-sales-report-extended.component.scss']
})
export class SupplySalesReportExtendedComponent implements OnInit {
  ...
  exportToPdf = () => {
    ...
    var title  = 'Supply Sales Report(Extended) Generated on '+ (new Date()).toString()
    var logo : any = ''
    var total : number = 0
    ...
    var report = [
      [
        ...
        {text : 'Stock', fontSize : 9, fillColor : '#bdc6c7'},
        {text : 'Qty', fontSize : 9, fillColor : '#bdc6c7'},
        {text : 'Disc', fontSize : 9, fillColor : '#bdc6c7'},
        {text : 'VAT', fontSize : 9, fillColor : '#bdc6c7'},
        {text : 'Margin', fontSize : 9, fillColor : '#bdc6c7'},
    ...
    this.report.forEach((element) => {
      ...
      var detail = [
        {text : element.code.toString(), fontSize : 7, fillColor : '#ffffff'}, 
        {text : element.description.toString(), fontSize : 7, alignment : 'left', fillColor : '#ffffff'},
        {text : ((element.stock*10)/10).toString(), fontSize : 7, alignment : 'left', fillColor : '#ffffff'},  
        {text : ((element.qty*10)/10).toString(), fontSize : 7, alignment : 'left', fillColor : '#ffffff'},  
        {text : element.discount.toLocaleString('en-US', { minimumFractionDigits: 2 }), fontSize : 7, alignment : 'right', fillColor : '#ffffff'},
        {text : element.tax.toLocaleString('en-US', { minimumFractionDigits: 2 }), fontSize : 7, alignment : 'right', fillColor : '#ffffff'},
        {text : element.profit.toLocaleString('en-US', { minimumFractionDigits: 2 }), fontSize : 7, alignment : 'right', fillColor : '#ffffff'},
        {text : element.amount.toLocaleString('en-US', { minimumFractionDigits: 2 }), fontSize : 7, alignment : 'right', fillColor : '#ffffff'},

      ]
      report.push(detail)
    })
    var detailSummary = [
      {text : '', fontSize : 7, alignment : 'left', fillColor : '#CCCCCC'}, 
      {text : '', fontSize : 7, alignment : 'left', fillColor : '#CCCCCC'},
      {text : '', fontSize : 7, alignment : 'left', fillColor : '#CCCCCC'},  
      {text : '', fontSize : 7, alignment : 'left', fillColor : '#CCCCCC'}, 
      {text : '', fontSize : 7, alignment : 'left', fillColor : '#CCCCCC'},
      ...
      watermark : { text : '', color: 'blue', opacity: 0.1, bold: true, italics: false },
        content : [
          ...
          '  ',
          {
            ...
            table : {
                headerRows : 1,
                widths : [40, 170, 30, 30, 50, 50, 50, 60],
                body : report
            }
        },                   
      ]     
  ...
  async exportToSpreadsheet() {
    ...
    worksheet.columns = [
      ...
      { header: 'CURRENT_STOCK', key: 'CURRENT_STOCK'},
      { header: 'QTY', key: 'QTY'},
